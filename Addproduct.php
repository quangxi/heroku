...
<body>
	...
	<div class="wrapper">
		...
		if(isset($_POST['add_product'])){
			...
			$sql = "INSERT INTO product (product_id, product_name, product_image,product_price, product_type) VALUES(NULL,'$product_name','$product_image','$product_price','$product_type')";
