	...
	<div class="wrapper">
		...
		<div class="content">
			<div class="low">
				...
				<div class="type">
					<ul>
						<li><a href="#">Dog</a></li><br>
						<li><a href="#">Cat</a></li><br>
						<li><a href="#">Mouse</a></li><br>
						<li><a href="#">Duck</a></li><br>
						<li><a href="#">Elephant</a></li><br>
					</ul>
				</div>
			</div>
			<div class="up">
				...
				<div class="animal_box">
					<?php
					include("Connect.php");
					$sql = "SELECT * FROM animal WHERE animal_name LIKE'%{$search}'";
					...
					while ($row=mysqli_fetch_array($result)) {
						...
						<a href='Trangchu.php?cart=$animal_id'></a>
